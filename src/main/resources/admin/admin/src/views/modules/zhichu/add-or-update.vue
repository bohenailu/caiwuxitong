<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="账号类型" prop="zhanghaoleixing">
          <el-select :disabled="ro.zhanghaoleixing" v-model="ruleForm.zhanghaoleixing" placeholder="请选择账号类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="账号类型" prop="zhanghaoleixing">
	      <el-input v-model="ruleForm.zhanghaoleixing"
                placeholder="账号类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouzhileixing = true;
          ...
          if(o=='zhanghaoleixing'){
            this.ruleForm.zhanghaoleixing = obj[o];
	    this.ro.zhanghaoleixing = true;
            continue;
          }
          if(o=='jine'){
