<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预算金额" prop="yusuanjine">
          <el-input v-model="ruleForm.yusuanjine" 
              placeholder="预算金额" clearable  :readonly="ro.yusuanjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预算金额" prop="yusuanjine">
              <el-input v-model="ruleForm.yusuanjine" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="每周金额" prop="meizhoujine">
          <el-input v-model="ruleForm.meizhoujine" 
              placeholder="每周金额" clearable  :readonly="ro.meizhoujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="每周金额" prop="meizhoujine">
              <el-input v-model="ruleForm.meizhoujine" 
                placeholder="每周金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='yusuanjine'){
            this.ruleForm.yusuanjine = obj[o];
	    this.ro.yusuanjine = true;
            continue;
          }
          if(o=='meizhoujine'){
            this.ruleForm.meizhoujine = obj[o];
	    this.ro.meizhoujine = true;
            continue;
          }
          if(o=='shiyongshijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiaofeiyusuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiaofeiyusuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
